...
def parse_arguments():
    ...
    parser.add_argument('--use_model', default='models/Long-ViT-L-14-REG-GATED-full-model.safetensors', help="Path to REG-XGATED CLIP model")
...
plt.legend()
plt.grid(True)
plt.savefig(os.path.join(SAVE_FOLDER, "long_per_layer_fusion_gate_distrib.png"))
plt.close()
